...
# Email Configuration
# Configuration pour l'envoi d'emails réels avec Gmail SMTP
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'dabou0110@gmail.com'  # Votre adresse Gmail
EMAIL_HOST_PASSWORD = 'izlv rgin tdlf evij'  # Votre mot de passe d'application Gmail
DEFAULT_FROM_EMAIL = 'dabou0110@gmail.com'  # Votre adresse Gmail

# Pour le débogage, vous pouvez réactiver la console avec :
...
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic',  # Utiliser whitenoise pour servir les fichiers statiques
...
# Les paramètres d'email sont définis plus haut dans le fichier
